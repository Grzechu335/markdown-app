    ...
    return (
        <div className="absolute flex flex-col flex-1 w-full h-full md:static">
            ...
            <textarea
                ...
                className="w-full h-full max-h-full px-4 pt-2 pb-24 overflow-y-scroll outline-none resize-none md:static scrollbar-none dark:text-400 text-700 bg-100 dark:bg-1000 markdown-code"
            />
        </div>
    )
}
