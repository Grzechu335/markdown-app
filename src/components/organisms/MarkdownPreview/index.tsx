...
const MarkdownPreview: React.FC = () => {
    ...
    return (
        <m.div
            ...
            className="absolute flex-col md:static md:flex flex-1 w-full h-full max-h-full overflow-y-scroll scrollbar-none md:border-l-[1px] md:border-300 md:dark:border-600 "
        >
